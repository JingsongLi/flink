 ...
 */
@Internal
public class LocalSampleOperator extends TableStreamOperator<IntermediateSampleData<BaseRow>>
		implements OneInputStreamOperator<BaseRow, IntermediateSampleData<BaseRow>>, BoundedOneInput {
	...
	public void open() throws Exception {
		...
		sampler.setProjection(localSampleProjection.newInstance(getUserCodeClassloader()));
