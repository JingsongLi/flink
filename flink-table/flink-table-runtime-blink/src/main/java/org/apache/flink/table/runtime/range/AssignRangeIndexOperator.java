 ...
 */
public class AssignRangeIndexOperator extends TableStreamOperator<Tuple2<Integer, BaseRow>>
		implements TwoInputStreamOperator<Object[][], BaseRow, Tuple2<Integer, BaseRow>>, InputSelectable {

	private final KeyExtractor keyExtractor;

	private transient RangeBoundaries<BaseRow> rangeBoundaries;
	...
	@Override
	public void processElement1(StreamRecord<Object[][]> streamRecord) throws Exception {
	...
	public InputSelection nextSelection() {
		return rangeBoundaries == null ? InputSelection.FIRST : InputSelection.ALL;
	}
}
